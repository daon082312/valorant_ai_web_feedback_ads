...
from video_killfeed_detector_v3 import VideoKillfeedDetectorV3
...
def analyze_video(video_path, config, root_dir, progress=None):
    ...
    v710.VideoKillfeedDetector = VideoKillfeedDetectorV3
    try:
    ...
    combat["detector"] = "top_right_killfeed_self_highlight_v3_novel_row"
    report["combat"] = combat
    report["killfeed_kills"] = kills
    report["kill_detection_version"] = "top_right_killfeed_self_highlight_v3_novel_row"
    ...
    feedback.insert(0, f"오른쪽 위 킬로그의 새 최상단 행과 내 킬 강조를 함께 확인해 내 킬 {kills}회를 감지했습니다.")
